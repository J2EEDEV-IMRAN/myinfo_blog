...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>ColVis adds a button to the toolbars around DataTables which gives the end login of the table the ability to dynamically change the visibility of the columns in
				the table:</p>
