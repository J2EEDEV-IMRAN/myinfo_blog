...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>ColVis is a plug-in for DataTables which presents a list of all columns to a login and allows them to select which ones they wish to be visible. Click the 'Show
