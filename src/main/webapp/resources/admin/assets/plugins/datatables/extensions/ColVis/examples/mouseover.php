...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>The default activation (showing the columns list) for ColVis is for the login to click the button. This can be altered to a <code>mouseover</code> activation by
