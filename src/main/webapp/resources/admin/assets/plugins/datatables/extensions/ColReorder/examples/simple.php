...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>This example shows the basic use case of the ColReorder plug-in. With ColReorder enabled for a table, the login has the ability to click and drag any table
