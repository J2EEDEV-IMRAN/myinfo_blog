...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>When displaying a table which scrolls along the x-axis, it can sometimes be useful to the end login for the left most column to be fixed in place, if it shows
