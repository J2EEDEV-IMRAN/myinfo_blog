...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>It can at times be useful to exclude columns from being in the 'show / hide' list (for example if you have hidden information that the end login shouldn't be
