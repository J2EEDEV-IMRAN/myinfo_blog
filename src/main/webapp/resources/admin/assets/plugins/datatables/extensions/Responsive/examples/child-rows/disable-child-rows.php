...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>By default, when Responsive collapses a table, it will show an option for the end login to expand the row, showing the details of the hidden columns in a child
				...
				case the hidden data is not directly accessible to the end login.</p>
			</div>
