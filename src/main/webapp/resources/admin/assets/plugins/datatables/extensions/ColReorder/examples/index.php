...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>ColReorder adds the ability for the end login to click and drag column headers to reorder a table as they see fit, to DataTables. Key features include:</p>
