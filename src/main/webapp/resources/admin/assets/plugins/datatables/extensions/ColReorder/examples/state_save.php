...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>A useful interaction pattern to use in DataTables is state saving, so when the end login reloads or revisits a page its previous state is retained. ColReorder
