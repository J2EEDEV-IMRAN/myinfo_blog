	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				Responsive will show child row controls in the first column when the table has been collapsed, allowing the end login to show / hide the information from the hidden
				columns.</p>
