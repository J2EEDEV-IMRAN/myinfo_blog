...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>While the ColReorder insertion point indicator can be styled, another option to show the end login what the column will look like when the table has been
