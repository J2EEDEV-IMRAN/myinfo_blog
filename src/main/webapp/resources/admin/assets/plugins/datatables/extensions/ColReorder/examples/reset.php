...
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>One useful control option to present the end login when using ColReorder is the ability to reset the column ordering to that which was found in the HTML. This
