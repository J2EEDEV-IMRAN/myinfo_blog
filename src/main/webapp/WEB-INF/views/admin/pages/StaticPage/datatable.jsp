    ...
    <!-- Default panel contents -->
 	<div class="panel-heading text-center text-primary">
 		...
 		<span class="pull-right">
 			<a href="#StaticPage/create/${rand}" role="button">
    ...
    <div class="panel-body">
  		<div class="table-responsive">
			<table id="datatable_for_staticPage" class="datatable table table-striped table-bordered dt-responsive nowrap compact stripe"
				...
				data-scrollY="&quot;200px&quot;"
				data-searching="true"
				data-ajax-url="<c:url value="/admin/staticPage/data?${_csrf.parameterName}=${_csrf.token}"/>"
				...
				width="100%"
				data-columns-sequence="index,pageUrl,pageTitleEnglish,pageTitleBangla,status,action"
			>
				<thead>
					...
					<th name="pageTitleEnglish" value="pageTitleEnglish" data-priority="4">Page Title English</th>
					<th name="pageTitleBangla" value="pageTitleBangla" data-priority="5">Page Title Bangla</th>
					<th name="status" value="status" data-priority="6">Status</th>
				
					<th name="action" value="id" data-edit="true" data-delete="true" data-view="true" data-delete-url="admin/staticPage/delete/:id" data-edit-url="admin#staticPage/edit/:id" data-view-url="admin#staticPage/details/:id" data-view-button-class="btn btn-primary btn-sm" data-edit-button-class="btn btn-info btn-sm" data-delete-button-class="btn btn-danger btn-sm" data-view-icon-class="fa fa-info-circle" data-edit-icon-class="" data-delete-icon-class="fa fa-trash" data-notexport="true" data-orderable="false" data-searchable="false" data-priority="2">Action</th>
				</thead>
			</table>
		</div>
