                         ...
                         <div class="col-sm-8">
                             <nav aria-label="Page navigation">
                                ...
                                <c:if test="${fn:contains(queryString,'page')}">
                                    ...
                                    <li Class="${PostList.hasPrevious()? '':'disabled hide'}"><a class="page-link" href="${contextPath}/blogby-year.html${pageNo}&page=${PostList.previousPageable().getPageNumber()+1}">
                                         ...
                                         <c:choose>
                                           ...
                                           <%--      <li class="page-item">
                                                 ...
                                                 <c:choose>
                                                    ...
                                                    <li class="page-item">
                                                         <a href="${contextPath}/blogby-year.html${pageNo}&page=${loop.index}">${loop.index}</a>
                                                    </li>
                                                     </c:when>
                                                     <c:otherwise>
                                                    <li class="page-item">
                                                         <a href="${contextPath}/blogby-year.html${queryString}&page=${loop.index}">${loop.index}</a>
                                                    </li>
                                                     </c:otherwise>
                                                 </c:choose>
                                             </c:otherwise>
                                     ...
                                     <c:if test="${fn:contains(queryString,'page')}">
                                         <c:set var="pageNo" value="${fn:substring(queryString, 0, queryString.lastIndexOf('&'))}"  />
                                         <li class="${PostList.hasNext()? '':'disabled hide'}"><a class="page-link" href="${contextPath}/blogby-year.html${pageNo}&page=${PostList.nextPageable().getPageNumber()+1}">
                                           <span aria-hidden="true">
