                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-8">
                             <nav aria-label="Page navigation">
                                 <ul class="pagination">
                                     <li Class="${PostList.hasPrevious()? '':'disabled hide'}"><a class="page-link" href="${contextPath}/blogby-tag-${tagId}.html?page=${PostList.previousPageable().getPageNumber()+1}">
                                     ...
                                     <c:forEach begin="${initialPage}" end="${endingPage}" varStatus="loop">
                                         ...
                                         <c:choose>
                                             ...
                                             <c:otherwise>
                                                 <li class="page-item">
                                                     <a class="page-link" href="${contextPath}/blogby-tag-${tagId}.html?page=${loop.index}">${loop.index}</a>
                                                 </li>
                                             </c:otherwise>
                                         </c:choose>

                                     </c:forEach>
                                     <li class="${PostList.hasNext()? '':'disabled hide'}"><a class="page-link" href="${contextPath}/blogby-tag-${tagId}.html?page=${PostList.nextPageable().getPageNumber()+1}">
                                           <span aria-hidden="true">
